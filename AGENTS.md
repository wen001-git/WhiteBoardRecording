...
| 日期 | 变更内容 |
|------|----------|
| 2026-07-17 | 让提词器支持标题栏拖动并修复打开后遮住幻灯片选择面板；why：编辑白板时可主动让出内容区域且保留幻灯片导航 |
| 2026-07-17 | 为两个白板版本增加框选多选、整体移动与批量删除并配套回归测试；why：补齐类似 Excalidraw 的多对象整理能力 |
| 2026-07-17 | 提高两个白板版本的贴纸工具面板层级并增加回归测试；why：避免幻灯片标签、边框和笔迹按钮穿透工具面板 |

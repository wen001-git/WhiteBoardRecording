...
| 2026-07-21 | 为逐页转场增加翻书、轻柔滑动和柔和提示音、音量、试听及录制混音，并将文档升级到 v5；why：让画面转场和声音以一套紧凑设置直接进入成品视频 |
| 2026-07-21 | 为普通版与 Pro 版增加逐页幻灯片转场、三档速度及录制合成，并明确 `whiteboard.html` 是除账号权限外功能全开的创作者版本；why：统一两版核心创作能力并让切页效果直接进入成品视频 |

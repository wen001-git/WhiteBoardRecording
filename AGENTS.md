...
- 两个白板版本的提词器支持统一调整讲稿字色，编辑态与播放态同步显示，并随 v3 白板文档及浏览器草稿保存、恢复。
...
| 日期 | 变更内容 |
|------|----------|
| 2026-07-21 | 为普通版与 Pro 版提词器增加可持久化的统一文字颜色；why：让用户根据背景和阅读偏好调整讲稿字色 |
| 2026-07-21 | 为普通版与 Pro 版提词器增加视口内拖拽缩放；why：扩大长讲稿的浏览面积并避免浮窗越界 |
| 2026-07-20 | 将提词器讲稿、速度和字号纳入 v3 白板文件及自动草稿，并兼容旧本机讲稿；why：让用户保存和重开白板时完整恢复讲稿设置 |
